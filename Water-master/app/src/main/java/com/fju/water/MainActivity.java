...
public class MainActivity extends AppCompatActivity {
    ...
    public void check(View view){
        ...
        if (TextUtils.isEmpty()){
            ...
            pay = month*7.35;
        }else if (monthly.length()<=30&&monthly.length()>10){
            pay.setText(month*9.45-21);
        }else if (monthly.length()<=50&&monthly.length()>30){
            pay.setText(month*11.5-84);
        }else if (monthly.length()>50) {
        ...
        }else if (dbmonthly.length()<=60&&dbmonthly.length()>20){
            pay.setText(next*9.45-42);
        }else if (dbmonthly.length()<=100&&dbmonthly.length()>60){
            pay.setText(next*11.5-168);
        }else if (dbmonthly.length()>50){
